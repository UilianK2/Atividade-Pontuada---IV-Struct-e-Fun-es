...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            {
                system("cls || clear");
                printf("Digite o nome do %d funcionario : ", numFuncionarios + 1);
                scanf("%s", programadores[numFuncionarios].nome);

                printf("Digite o cargo do %d funcionario : ", numFuncionarios + 1);
                scanf("%s", programadores[numFuncionarios].cargo);

                printf("Digite o salario do %d funcionario: ", numFuncionarios + 1);
